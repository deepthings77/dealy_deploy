...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
      try {
        ...
        const res = await axios.get(`https://dealy-deploy-r2gznzcg6-deepthings77s-projects.vercel.app/api/v1/post/${post?._id}/${action}`, { withCredentials: true });
    ...
    const commentHandler = async () => {
        try {
            ...
            const res = await axios.post(`https://dealy-deploy-r2gznzcg6-deepthings77s-projects.vercel.app/api/v1/post/${post?._id}/comment`, { text }, {
              headers: {
    ...
    const deletePostHandler = async () => {
        try {
          ...
          const res = await axios.delete(`https://dealy-deploy-r2gznzcg6-deepthings77s-projects.vercel.app/api/v1/post/delete/${post?._id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const bookmarkHandler = async () => {
      try {
        ...
        const res = await axios.get(
          `https://dealy-deploy-r2gznzcg6-deepthings77s-projects.vercel.app/api/v1/post/${post?._id}/bookmark`,
          { withCredentials: true }
        );
